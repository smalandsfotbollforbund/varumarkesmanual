---
description: När SmFF är en del av det nationella systemet – och när vi talar med vår egen röst.
---
...
{% tabs %}
{% tab title="SmFF-primärt" %}
SmFF:s emblem är det enda förbundsvarumärket. SvFF syns inte, eller enbart i en fotnot.
...
Båda logotyperna är synliga och jämbördiga. SmFF:s emblem är primärt – placerat till vänster.
...
**Placering:** SmFF vänster · SvFF höger · Vertikal linje emellan\
**Storleksförhållande:** Max 120/100 – SmFF aldrig mer än 20 % mindre
{% endtab %}

{% tab title="SvFF-primärt" %}
SvFF:s grafiska riktlinjer styr. SmFF:s identitet manifesteras i bildval, tonalitet och det redaktionella innehåll vi kontrollerar.
...
| Läge | Primärfärg | Accent | Bakgrund |
|---|---|---|---|
| SmFF-primärt | Smålandsröd `#A91C1C` | Skogsgrön `#2F5731` | Vit / Torparbeige |
...
Webbplatsen är byggd i SvFF:s infrastruktur och kan inte förändras i grundstruktur eller färgsättning. SmFF:s identitet manifesteras i stället genom:
