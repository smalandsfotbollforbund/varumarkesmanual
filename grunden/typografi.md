...
SvFF Trim är ett specialritat condensed-typsnitt. Prickar och specialtecken (Å, Ä, Ö) har formen av en ruta – en diskret referens till fotbollen. **Trim finns bara i versaler.** Den används stor, kraftfull och med självförtroende. Kompakt radavstånd är korrekt – det är inte ett misstag.
{% endcolumn %}
...
Stag Sans ritades 2008 av Christian Schwartz på Commercial Type. Det kompletterar SvFF Trim utan att konkurrera med det och fungerar lika bra som underrubrik och brödtexttypsnitt.
{% endcolumn %}
...
SvFF TRIM (VERSALER, RÖDA ELLER VITA)
  ↳ Det som syns på ett ögonkast – det kraftfulla budskapet

Stag Sans Semibold
  ↳ Fördjupning och underavdelning

Stag Sans Book
  ↳ Den löpande berättelsen.
    Alltid generöst radavstånd. Aldrig tätare än 9 pt.
