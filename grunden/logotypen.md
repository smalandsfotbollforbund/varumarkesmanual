...
Passar mot: Linnevit `#FFFFFF` · Stenmursgrå `#F2F2F2` · Torparbeige `#E2DBD0`
{% endtab %}
...
Passar mot: Smålandsröd `#A91C1C` · Skogsgrön `#2F5731` · Kolsvart `#333333`
{% endtab %}
...
Förenklad version utan subtila detaljer, optimerad för screentryck på textil.
